...
namespace Minem.Sgpam.LogicaNegocio.Implementaciones
{
    ...
    public class T_Sgpad_Eum_InspeccionLN : BaseLN, IT_Sgpad_Eum_InspeccionLN
    {
        ...
        public bool AnularEum_InspeccionDTOPorCodigo(Eum_InspeccionDTO vEum_InspeccionDTO)
        {
            bool vResult = false;
            try
            {
                if (vEum_InspeccionDTO != null)
                {
                    ...
                    vResult = Eum_InspeccionAD.AnularT_Sgpad_Eum_InspeccionPorCodigo(vRegistro) != 0;
                }
                return vResult;
            }
            catch (Exception ex)
