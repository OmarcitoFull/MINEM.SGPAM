...
namespace Minem.Sgpam.LogicaNegocio.Interfaces
{
    ...
    public interface IT_Sgpad_Eum_Info_DescargoLN
    {
        ...
        Eum_Info_DescargoDTO GrabarEum_Info_DescargoDTO(Eum_Info_DescargoDTO vEum_Info_DescargoDTO);
        bool AnularEum_Info_DescargoDTOPorCodigo(Eum_Info_DescargoDTO vEum_Info_DescargoDTO);
