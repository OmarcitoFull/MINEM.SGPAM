...
namespace Minem.Sgpam.LogicaNegocio.Interfaces
{
    ...
    public interface IT_Sgpad_Lnr_Info_GraficaLN
    {
        ...
        Lnr_Info_GraficaDTO GrabarLnr_Info_GraficaDTO(Lnr_Info_GraficaDTO vLnr_Info_GraficaDTO);
        ...
        IEnumerable<Lnr_Info_GraficaDTO> ListarPorIdLnrLnr_Info_GraficaDTO(int vId_Lnr);
    }
}