...
namespace Minem.Sgpam.LogicaNegocio.Interfaces
{
    ...
    public interface IT_Sgpad_Eum_Info_GraficaLN
    {
        ...
        Eum_Info_GraficaDTO InsertarEum_Info_GraficaDTO(Eum_Info_GraficaDTO vEum_Info_GraficaDTO);
        Eum_Info_GraficaDTO ActualizarEum_Info_GraficaDTO(Eum_Info_GraficaDTO vEum_Info_GraficaDTO);
