...
namespace Minem.Sgpam.ClienteInterno.Controllers
{
    ...
    public class RegistrarPAMController : Controller
    {
        ...
        public async Task<JsonResult> GrabarObservacion(Comp_ObservacionDTO vObservacion)
        {
            ...
            vObservacion.Usu_Ingreso = vObservacion.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarRiesgosSeguridadHumana(Comp_Riesgo_Seg_HumDTO vRiesgo_Seg_Hum)
        {
            ...
            vRiesgo_Seg_Hum.Usu_Ingreso = vRiesgo_Seg_Hum.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarRiesgosSaludHumana(Comp_Riesgo_Sal_AmbDTO vRiesgo_Sal_Amb)
        {
            ...
            vRiesgo_Sal_Amb.Usu_Ingreso = vRiesgo_Sal_Amb.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarRiesgosFaunaSilvestre(Comp_Riesgo_Fau_ConDTO vRiesgo_Fau_Con)
        {
            ...
            vRiesgo_Fau_Con.Usu_Ingreso = vRiesgo_Fau_Con.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarMedicionesCampo(Comp_MedicionDTO vMedicion)
        {
            ...
            vMedicion.Usu_Ingreso = vMedicion.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarComentarios(Comp_ComentarioDTO vComentario)
        {
            ...
            vComentario.Usu_Ingreso = vComentario.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarEstudioAmbientales(Comp_Est_AmbDTO vEst_Amb, IFormFile vFile, [FromServices] IHostingEnvironment vHostingEnviroment)
        {
            ...
            vEst_Amb.Usu_Ingreso = vEst_Amb.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarEncargoRemediacion(Comp_Enc_RemDTO vEnc_Rem)
        {
            ...
            vEnc_Rem.Usu_Ingreso = vEnc_Rem.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarReaprovechamiento(Comp_ReaproDTO vReapro)
        {
            ...
            vReapro.Usu_Ingreso = vReapro.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarInformeCampo(Comp_Info_CampoDTO vInfo_Campo)
        {
            ...
            vInfo_Campo.Usu_Ingreso = vInfo_Campo.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarResultado(Comp_ResultadoDTO vResultado)
        {
            ...
            vResultado.Usu_Ingreso = vResultado.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
        ...
        public async Task<JsonResult> GrabarEstadoGestion(Comp_Est_GestionDTO vEst_Gestion)
        {
            ...
            vEst_Gestion.Usu_Ingreso = vEst_Gestion.Usu_Modifica = GlobalAppSession.GetCurrentSesion(User);
