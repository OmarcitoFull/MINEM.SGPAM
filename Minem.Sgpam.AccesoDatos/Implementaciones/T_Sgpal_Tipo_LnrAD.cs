...
namespace Minem.Sgpam.AccesoDatos.Implementaciones
{
    ...
    {
        public T_Sgpal_Tipo_LnrAD(IConfiguration vConfiguration)
        {
        ...
        public T_Sgpal_Tipo_Lnr InsertarT_Sgpal_Tipo_Lnr(T_Sgpal_Tipo_Lnr vT_Sgpal_Tipo_Lnr)
        {
            using (OracleConnection vCnn = new OracleConnection(CnnString))
            {
                ...
                {
                    vCmd.CommandType = CommandType.StoredProcedure;
                    vCmd.Parameters.Add("pIP_INGRESO", vT_Sgpal_Tipo_Lnr.IP_INGRESO); 				vCmd.Parameters.Add("pIP_MODIFICA", vT_Sgpal_Tipo_Lnr.IP_MODIFICA); 				vCmd.Parameters.Add("pFEC_INGRESO", vT_Sgpal_Tipo_Lnr.FEC_INGRESO); 				vCmd.Parameters.Add("pID_TIPO_LNR", vT_Sgpal_Tipo_Lnr.ID_TIPO_LNR); 				vCmd.Parameters.Add("pUSU_MODIFICA", vT_Sgpal_Tipo_Lnr.USU_MODIFICA); 				vCmd.Parameters.Add("pDESCRIPCION", vT_Sgpal_Tipo_Lnr.DESCRIPCION); 				vCmd.Parameters.Add("pUSU_INGRESO", vT_Sgpal_Tipo_Lnr.USU_INGRESO); 				vCmd.Parameters.Add("pFEC_MODIFICA", vT_Sgpal_Tipo_Lnr.FEC_MODIFICA); 				vCmd.Parameters.Add("pFLG_ESTADO", vT_Sgpal_Tipo_Lnr.FLG_ESTADO);
                    vCnn.Open();
