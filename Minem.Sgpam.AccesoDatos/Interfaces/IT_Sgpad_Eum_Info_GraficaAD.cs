...
{
    /// <summary>
    /// Objetivo:	Interfaz que matricula las operaciones para la tabla T_SGPAD_EUM_INFO_GRAFICA
    /// Creado Por:	Omar Rodriguez Muñoz
    /// Fecha Creación:	28/10/2021
    /// </summary>
    public interface IT_Sgpad_Eum_Info_GraficaAD
    {
        IEnumerable<T_Sgpad_Eum_Info_Grafica> ListarT_Sgpad_Eum_Info_Grafica();
