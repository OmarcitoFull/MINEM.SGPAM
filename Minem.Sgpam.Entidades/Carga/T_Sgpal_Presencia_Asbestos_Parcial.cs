...
namespace Minem.Sgpam.Entidades
{
    ...
    /// </summary>
    public partial class T_Sgpal_Presencia_Asbestos 
    { 
        public T_Sgpal_Presencia_Asbestos()
        {

        }

        public T_Sgpal_Presencia_Asbestos(IDataReader vRdr)
        {
			...
			this.ID_PRESENCIA_ASBESTOS = Convert.ToInt32(vRdr["ID_PRESENCIA_ASBESTOS"]);  
