...
namespace Minem.Sgpam.Entidades
{
    ...
    /// </summary>
    public partial class T_Sgpal_Contencion_Residuo 
    { 
        public T_Sgpal_Contencion_Residuo()
        {

        }

        public T_Sgpal_Contencion_Residuo(IDataReader vRdr)
        {
