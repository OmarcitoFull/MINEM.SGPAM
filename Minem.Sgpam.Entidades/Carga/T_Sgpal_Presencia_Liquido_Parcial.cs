...
namespace Minem.Sgpam.Entidades
{
    ...
    /// </summary>
    public partial class T_Sgpal_Presencia_Liquido 
    { 
        public T_Sgpal_Presencia_Liquido()
        {

        }

        public T_Sgpal_Presencia_Liquido(IDataReader vRdr)
        {
            			this.ID_PRESENCIA_LIQUIDO = Convert.ToInt32(vRdr["ID_PRESENCIA_LIQUIDO"]);  
